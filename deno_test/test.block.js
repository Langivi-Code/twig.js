...
import { twig, renderToString } from "../src/twig.js";
...
Deno.test("Twig.js Blocks ->", async t => {
    ...
    await t.step("should understand {% endblock title %} syntax", async t => {
        ...
        const resultTemp = await twig.twig({ ref: "endblock-extended-syntax" });
        assertEquals(resultTemp.render({}), "This is the only thing.");
    });
    ...
    await t.step(
        ...
        async t => {
            ...
            await twig.twig({
                ...
                load(template) {
                    assertEquals(
                        template.render({ base: "template.twig" }),
                        "Other Title - child"
                    );
                },
                error
    ...
    await t.step("should have access to a parent block content", async t => {
        const error = error => console.log("ERROR", error);
        await twig.twig({
            id: "child-parent",
    ...
    await t.step("should render nested blocks", async t => {
        const error = error => console.log("ERROR", error);
        await twig.twig({
            id: "blocks-nested",
            ...
            load(template) {
                assertEquals(template.render({}), "parent:child");
            },
            error
        });
    });

    await t.step("should render extended nested blocks", async t => {
        const error = error => console.log("ERROR", error);
        await twig.twig({
    ...
    await t.step(
        ...
        async t => {
            ...
            await twig.twig({
                ...
                load(template) {
                    assertEquals(
                        template.render({ base: "b/template.twig" }),
                        "Other Title - child"
                    );
                },
                error
    ...
    await t.step("should override blocks in loop when extending", async (t) => {
        const result1 = await twig.twig({
            id: "block-loop.twig",
            data:
    ...
    await t.step("should allow overriding of included blocks", async (t) => {
        await twig.twig({
            ...
            load(template) {
                // Load the template
                assertEquals(template.render({place: 'diner'}),'Sorry, can\'t come to a diner today.');
            },
    ...
    await t.step('should allow "parent()" call when importing blocks', async (t) => {
        await twig.twig({
            id: 'use-override-nested-block',
                path: './templates/use-override-nested-block.twig',
            load(template) {
                // Load the template
                assertEquals(template.render({}),'parent:new-child1:new-child2');
            },
            error(error){console.log(error)}
        });
        }
...
Deno.test("block function ->", async (t)=>{
    await t.step('should render block content from an included block', async (t)=>{
        let result;
        await twig.twig({
            path: './templates/block-function.twig',
            load(template){result = template},
    ...
    await t.step('should render block content from a parent block', async (t)=>{
        let result;
        await twig.twig({
    ...
    await t.step('should render block content with outer context', async (t)=>{
        let result;
        await twig.twig({
    ...
    await t.step('should respect changes of the context made before calling the function', async (t)=>{
        const result = await twig.twig({
...
Deno.test("block shorthand ->", async (t)=>{
    await t.step('should render block content using shorthand syntax', async (t)=>{
        const result = await twig.twig({
    ...
    await t.step('should overload blocks from an extended template using shorthand syntax', async (t)=>{
        await twig.twig({
