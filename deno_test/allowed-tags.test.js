...
Deno.test("Twig.js Allowed-Tags", async (t) => {
  await t.step("Should apply allowed_tags argument", async () => {
    const content =
      '<a href="#">linktest</a> <b>boldtest</b> <p>paragraphtest</p>';
    ...
    assertEquals(
      output,
      'template with <a href="#">linktest</a> <b>boldtest</b> <p>paragraphtest</p>',
    );
  });
  await t.step("should remove tags if no argument passed", async () => {
    const content =
      '<a href="#">linktest</a> <b>boldtest</b> <p>paragraphtest</p>';
