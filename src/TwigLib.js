...
import {sprintf, vsprintf, strip_tags, round, max, min, strtotime, date, boolval, clm, Currencies, datauri, lookup, fromUint8Array, datetime, turndown, DOMParser, langToLang, getLanguageName, getLanguageNameWithCountry, showdown, slug, timeZoneName, encode, createHash, ensureDirSync, emptyDirSync} from './twig.deps.js';
...
class TwigLib {
    constructor() {
        ...
        this.ensureDirSync = ensureDirSync;
